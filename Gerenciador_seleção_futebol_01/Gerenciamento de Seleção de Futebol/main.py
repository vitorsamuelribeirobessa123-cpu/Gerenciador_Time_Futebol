...
#Jogador adversário autor do gol 
...
# 2. Mudança para titular 
brasil.colocar_jogador_titular(novo_jogador) 

# 3. Print do novo status 
print(f"Novo status do {novo_jogador.get_nome()}: {novo_jogador.get_status()}")

print( )

# 4. Demissão 
brasil.demitir(novo_jogador)
print(f"Jogador demitido: {novo_jogador.get_nome()}")"""
